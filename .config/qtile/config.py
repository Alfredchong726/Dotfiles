...
groups = [Group("WWW", layout='monadtall'),
          ...
          Group("PYTHON", layout='monadtall'),
          Group("C", layout='monadtall'),
          Group("BASH", layout='monadtall'),
          Group("FISH", layout='monadtall'),
          Group("JAVA", layout='monadtall'),
          Group("PHP", layout='monadtall'),
          Group("JAVASCRIPT", layout='monadtall'),
...
>>>>>>> 2796cc601c52fee9944b2a709eeae864f17beec8
