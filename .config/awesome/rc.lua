...
globalkeys = gears.table.join(
    ...
    awful.key({ modkey            }, "x", function () awful.spawn('archlinux-logout') end,
              {description = "open archlinux-logout", group = "applications"}),
    awful.key({ modkey, "Shift"   }, "o", function () awful.spawn('obsidian') end,
              {description = "open obsidian", group = "applications"}),
    awful.key({ modkey, "Shift"   }, "t", function () awful.spawn('teams') end,
              {description = "open teams", group = "applications"}),
...
awful.spawn.with_shell("xrandr --output eDP1 --primary --mode 2160x1440 --pos 0x0 --rotate normal --output DP1 --off --output HDMI1 --off --output HDMI2 --mode 1920x1080 --pos 2160x0 --rotate normal --output VIRTUAL1 --off")
