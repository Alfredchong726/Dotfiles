...
myWorkspaces = [" WWW ", " FISH ", " BASH ", " PYTHON ", " PHP ", " C ", " JAVA ", " SYS ", " MUS "]
-- myWorkspaces =
--         " 1 : <fn=2>\xf111</fn> " :
--         " 2 : <fn=2>\xf1db</fn> " :
--         " 3 : <fn=2>\xf192</fn> " :
...
myKeys c =
  ...
  ^++^ subKeys "Application that commonly used"
  [ ("M-a", addName "Start the music player"   $ spawn "pavucontrol")
  , ("M-t", addName "Start Task Manager"       $ spawn "xfce4-taskmanager")
  , ("M-c", addName "Start VsCode"             $ spawn "code")
  , ("M-d", addName "Start File Manager"       $ spawn "thunar")
  , ("M-w", addName "Start Whatsapp"           $ spawn "whtsapp-for-linu")
  , ("M-x", addName "Start PowerMenu"          $ spawn "archlinux-logout")
  , ("M-S-o", addName "Start Obsidian"         $ spawn "obsidian")
  , ("M-S-t", addName "Start Microsoft Teams"  $ spawn "teams")
  , ("M-S-d", addName "Start Dmenu"            $ spawn dm)
  , ("M-S-c", addName "Alacritty theme changer"$ spawn "~/alchanger.sh")]
