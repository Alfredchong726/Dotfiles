...
myStartupHook :: X ()
myStartupHook = do
          spawnOnce "nitrogen --random --set-tiled &"
          spawnOnce "picom &"
          spawnOnce "nm-applet &"
...
myApplications = [ ("Deadbeef", "deadbeef", "Lightweight GUI audio player")
...
myBookmarks = [ ("GitHub", myBrowser ++ "https://github.com", "GitHub is a very good sources")
              , ("BiliBili", myBrowser ++ "https://www.bilibili.com", "BiliBili is a China website which has many animes")
              , ("YouTube", myBrowser ++ "https://www.youtube.com", "YouTube is fun")
              , ("Derek Taylor's GitLab", myBrowser ++ "https://gitlab.com/dwt1", "It has a lots of config files")
              , ("CSDN", myBrowser ++ "https://www.csdn.net/", "China IT skills communication platform")
              ]

myConfigs :: [(String, String, String)]
myConfigs = [ ("fish_config", myEditor ++ "~/.config/fish/config.fish", "the bourne again shell")
            , ("bspwm", myEditor ++ "~/.config/bspwm/bspwmrc", "bspwm config file")
            , ("qtile", myEditor ++ "~/.config/qtile/config.py", "qtile config")
            , ("qtile", myEditor ++ "~/.config/awesome/rc.lua", "awesome config")
            , ("openbox", myEditor ++ "~/.config/openbox/rc.xml", "openbox config")
            , ("xmonad", myEditor ++ "~/.xmonad/xmonad.hs", "xmonad config")
            , ("NeoVim", myEditor ++ "~/.config/nvim/init.lua", "NeoVim config")
            ]
...
archwiki, baidu, news :: S.SearchEngine

archwiki = S.searchEngine "archwiki" "https://wiki.archlinux.org/index.php?search="
baidu    = S.searchEngine "baidu" "https://www.baidu.com/s?wd="
...
myWorkspaces = clickable . map xmobarEscape
               $ ["WWW", "FISH", "PYTHON", "JAVA", "C", "PHP", "LUA", "SYS", "MUC"]
  where
